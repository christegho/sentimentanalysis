...
for iteration in range(0,nfold):
	 ...
	 resultsIteration = symScoreClassify4(testPosDocs, posLexicon, negLexicon, posLexiconWeights, negLexiconWeights, True)
	 ...
	 resultsIteration = symScoreClassify4(testNegDocs, posLexicon, negLexicon, posLexiconWeights, negLexiconWeights, False)
	 print resultsIteration[4:12]
	 resultsBow[iteration,:] += np.array(resultsIteration[4:12])
	 resultsSig2nonW[iteration,99:] = resultsIteration[13][0][:99]
	 resultsSig2W[iteration,99:] = resultsIteration[12][0][:99]